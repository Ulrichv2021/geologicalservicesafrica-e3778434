        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-white/90 tracking-wide">
              JORC (2012) & SAMREC (2016) Compliant
            </span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl lg:text-2xl text-white/85 max-w-3xl mx-auto leading-relaxed mb-12"
          >
            De-risking mineral investments through rigorous data integrity, 
            defensible resource estimation, and bankable feasibility studies 
            across Africa's most prospective terranes.
          </motion.p>
          ...
          >
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center">
              ...
              <div className="text-sm text-white/60">PFS & BFS to international standards</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center">
