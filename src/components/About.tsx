...
const credentials = [
  { icon: Award, label: "SACNASP Registered" },
  { icon: Shield, label: "SAMREC Compliant" },
  { icon: Users, label: "Competent Persons" },
];
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/80 leading-relaxed">
            Since 2016, Geological Services Africa has delivered cost-efficient, high-quality 
            geological consulting across the continent—bridging rigorous field geology with 
            advanced digital workflows to reduce risk and accelerate informed decision-making.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center mb-24">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {credentials.map((cred) => (
                  <div key={cred.label} className="flex items-center gap-2 bg-primary/20 rounded-lg px-3 py-2">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-white/75 leading-relaxed">
              ...
              <p>
                Our team of registered Competent Persons delivers resource estimations, 
                technical due diligence, and feasibility studies that meet the stringent 
                requirements of JORC (2012), SAMREC (2016), and international banking standards.
              </p>
            </div>
            <div className="pt-4">
